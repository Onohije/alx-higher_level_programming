...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        """Captures and returns the text printed to stdout by calling
           the specified method on the Rectangle.

    Args:
        rect (Rectangle): The Rectangle object to invoke the method on.
        method (str): The name of the method to run on the Rectangle.

    Returns:
        str: The text printed to stdout by calling the specified
